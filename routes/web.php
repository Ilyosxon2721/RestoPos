...
| Если нет — пропускает (главный домен pos.forris.uz).
|--------------------------------------------------------------------------
*/

/*
|--------------------------------------------------------------------------
| Landing Page (Главный домен — pos.forris.uz)
|--------------------------------------------------------------------------
*/
Route::get('/', function () {
    if (app()->bound('tenant')) {
...
/*
|--------------------------------------------------------------------------
| Регистрация (только на главном домене pos.forris.uz)
|--------------------------------------------------------------------------
*/
...
| Работают на субдомене (lolotea.pos.forris.uz/cabinet/dashboard)
